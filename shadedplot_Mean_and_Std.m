...
outFileName = [char(outFileName(1)),'_',char(outFileName(2)),'_',char(outFileName(3))];
...
subplot(2,2,2);
shadedplot(xAxis, [rightHip_mean+rightHip_std]', [rightHip_mean-rightHip_std]', [0.7 0.7 1], 'g');
...
subplot(2,2,4);
plot(rightKnee_mean);
shadedplot(xAxis, [rightKnee_mean+rightKnee_std]', [rightKnee_mean-rightKnee_std]', [0.7 0.7 1], 'g');
...
fprintf(fid,'%6.2f, %6.2f, %6.2f, %6.2f, %6.2f, %6.2f, %6.2f, %6.2f\n',...
    leftHip_mean, leftHip_std, rightHip_mean, rightHip_std, ...
    leftKnee_mean, leftKnee_std, rightKnee_mean, rightKnee_std);
fclose(fid);  %關閉檔案
